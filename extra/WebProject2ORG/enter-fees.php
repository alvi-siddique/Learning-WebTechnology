...
if (isset($_POST['submit'])) {
	...
	foreach ($users as $key => $user) {
		...
		if ($data[0] == $username) {
			...
			$data[5] = "Partial Fee: " . $total * 0.6 . ", Total Fee: " . $total; // update fees for the user
			$data[6] = "Tuition: " . $tuition . ", Labs: " . $labs . ", Miscellaneous: " . $miscellaneous . ", Activities: " . $activities . ", Total: " . $total; // update payment details for the user
